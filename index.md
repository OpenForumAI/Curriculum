...
<strong>Tips for using LLMs for Curriculum Development:</strong>
  <ul style="margin-top: 0.5em;">
<li>Try entering prompts into several different LLMs, such as NotebookLM and several chatbots.</li>
...
<li>Be specific as necessary: for example, "the class presentation should contain 15 slides. Each slide should have 4-6 bullet points."</li><br>
  </ul>
...
For more tips on LLM prompt engineering for curriculum development, see https://ieeexplore.ieee.org/document/10869091.
